...
复制以下代码到Application层下的：CCodeApplicationModule.cs
...
如果你生成了**权限功能**。复制以下代码到 CCodeApplicationModule.cs
中的 PreInitialize 方法中:
...
<text name="Size"  value="Size"></text>
<text name="Extension"  value="Extension"></text>
<text name="CategoryId"  value="CategoryId"></text>
<text name="Type"  value="Type"></text>
<text name="ParamId"  value="ParamId"></text>
<text name="Status"  value="Status"></text>
<text name="FileLocation"  value="FileLocation"></text>
<text name="CreationTime"  value="CreationTime"></text>


<text name="File" value="文件"></text><text name="QueryFile"  value="查询文件"></text><text name="CreateFile"  value="添加文件"></text><text name="EditFile"  value="编辑文件"></text><text name="DeleteFile"  value="删除文件"></text><text name="BatchDeleteFile" value="批量删除文件"></text><text name="ExportFile"  value="导出文件"></text>                             
